...
║    ╚═╝  ╚═╝╚═╝      ╚═════╝ ╚═╝  ╚═══╝                   ║
║  ═══════════════════════════════════════════════════════  ║
║  🌟 𝗔𝗣𝗢𝗡 𝗛𝗢𝗦𝗧𝗜𝗡𝗚 𝗣𝗔𝗡𝗘𝗟 — Premium Edition v3.0 🌟       ║
...
def check_joined(uid):
    ...
    for cu, cn in ch_list:
        try:
            mem = bot.get_chat_member(cu if str(cu).startswith("-100") else f"@{cu}", uid)
...
class DB:
    ...
    # Admin
def admin_log(self, aid, act, tgt=None, details=''):
    self.exe(
...
╚══════════════════════════════════════╝"""
        ...
        # ══════════════════════════════════════
            ...
            if channels:
                ...
                t += "No channels added.\nUsing default: @developer_apon_07\n"
            t += f"\n{BRAND_TAG}"
            try:
